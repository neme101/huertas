<div class="ficha">
  ...
  <div class="ficha-body">
    <ul>
      ...
      <li><strong>Distancia entre plantas:</strong> <?= $cultivo['distancia_entre_plantas_min']; ?> - <?= $cultivo['distancia_entre_plantas_max']; ?> m</li>
      <li><strong>Distancia entre surcos:</strong> <?= $cultivo['distancia_entre_surcos_min']; ?> - <?= $cultivo['distancia_entre_surcos_max']; ?> m</li>
      ...
      <li><strong>Cantidad (aprox) de semillas por gramo:</strong> <?= $cultivo['semillas_por_gramo']; ?></li>
    </ul>
  </div>
</div>